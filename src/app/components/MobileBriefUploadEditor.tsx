...
export default function MobileBriefUploadEditor({ 
  onSubmit, 
  initialData, 
  fetchBriefFromUrl 
    ...
    <div className="flex flex-col px-2 py-4">
      ...
      {showTitleSection && briefData && (
        <button
          ...
          className="fixed top-20 left-4 z-50 bg-white rounded-full p-2 shadow-lg"
        >
      ...
      <div className="w-full">
        ...
        {showTitleSection && (
          <>
            ...
            >
              <div className="flex justify-between items-center mb-2">
                <h2 className="text-base font-semibold">Research Prompt</h2>
                {!isPromptEditing && (
                  <button 
            ...
            >
              <div className="flex justify-between items-center mb-2">
                <h2 className="text-base font-semibold">Abstract/Conclusion</h2>
                {!isAbstractEditing && (
                  <button 
            ...
            <motion.div
              ...
              animate={showMetadataSection ? "visible" : "hidden"}
              variants={sectionVariants}
              className="flex justify-center gap-4 mt-6 mb-20"
            >
              <button
